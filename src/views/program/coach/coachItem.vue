...
<script>
import { getCoach, deleteCoach, updateCoach } from '@/api/coach'
...
export default {
    ...
    methods: {
        ...
        modifyCoach (info) {
            ...
            updateCoach({id, picture, intro, enable}).then((upData) => {
